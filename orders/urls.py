...
urlpatterns = [
    ...
    path('admin/refund-logs/', views.AdminRefundLogView.as_view(), name='admin-refund-logs'),
    path('admin/refund-logs/<int:pk>/complete/', views.AdminCompleteRefundView.as_view(), name='admin-complete-refund'),
